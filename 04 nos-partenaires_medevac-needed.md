...
Dans un message MEDEVAC « Nine Line », les lignes 3 et 4 utilisent le code OTAN standard.

Ligne 3 — Nombre de blessés par priorité

1x ALPHA – 1x CHARLIE

Cela signifie :

1 patient ALPHA = 1 blessé URGENT
(évacuation nécessaire immédiatement, idéalement < 2 h)
1 patient CHARLIE = 1 blessé PRIORITAIRE
(grave mais moins critique qu’un urgent)

➡️ Total : 2 blessés à évacuer

Ligne 4 — Équipement spécial requis

BRAVO

Dans le code MEDEVAC :

BRAVO = treuil / hoist requis

➡️ L’hélicoptère devra pouvoir effectuer une récupération au treuil.
